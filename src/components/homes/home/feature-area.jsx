...
const feature_data = [
  {
    ...
    title: "Consultation",
    description: <> Begin with a comprehensive consultation, where we understand your unique needs and objectives. </> ,
  },
  {
    id: 2,
    icon: "flaticon-cctv-9",
    title: "Custom Solutions",
    description: <> Our experts design tailored solutions, incorporating advanced technologies for efficiency. </> ,
  },
  {
    id: 3,
    icon: "flaticon-group",
    title: "Implementation",
    description: <> We execute with precision, ensuring your systems are seamlessly integrated for optimal performance. </> ,
  },
];

...
const ServiceArea = () => {
  return (
    <>
      <div className="service-area   pb-25">
        <div className="container">
          <div className="row text-center">
            <div className="col-12">
              <div className="tp-section-box p-relative mb-60">
                <h3 className="tp-big-text">Vision Mission</h3>
                <span className="tp-section-subtitle d-inline-block mb-10">
               Vision & Mission
                </span>
                <h2 className="tp-section-title">Shaping a Connected Future with Purpose and Innovation</h2>
              </div>
            </div>
          </div>
          <div className="row">
            {service_data.slice(0,2).map((item, i) => (
